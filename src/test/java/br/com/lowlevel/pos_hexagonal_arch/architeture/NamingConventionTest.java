package br.com.lowlevel.pos_hexagonal_arch.architeture;
...
@AnalyzeClasses(packages = "br.com.lowlevel.pos_hexagonal_arch")
public class NamingConventionTest {
    ...
    public static final ArchRule config_reside_only_config_package = classes()
            ...
            .should()
            .resideInAPackage("..pos_hexagonal_arch.config")
